...
namespace MetricsManager.Wpf.Client
{
    ...
    public partial class MetricsManagerClient 
    {
        ...
        /// </summary>
        /// <returns>Агент успешно зарегестрирован</returns>
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException<ProblemDetails>("\u0421\u0432\u044f\u0437\u044c \u0441 \u0430\u0433\u0435\u043d\u0442\u043e\u043c \u043d\u0435 \u0443\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u0430", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
        ...
        /// </summary>
        /// <returns>Агент готов к работе</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException<ProblemDetails>("\u0421\u0432\u044f\u0437\u044c \u0441 \u043c\u0435\u043d\u0435\u0434\u0436\u0435\u0440\u043e\u043c \u043d\u0435 \u0443\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u0430", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
        ...
        /// <returns>Агент удален</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task RemoveAsync(int agentId)
        {
            return RemoveAsync(agentId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Агент удален</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task RemoveAsync(int agentId, System.Threading.CancellationToken cancellationToken)
        {
            if (agentId == null)
                throw new System.ArgumentNullException("agentId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/agents/remove/{agentId}");
            urlBuilder_.Replace("{agentId}", System.Uri.EscapeDataString(ConvertToString(agentId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class AgentInfo
    {
        ...
        public override string ToString()
        {
            if (Enable)
            {
                return $"Агент {AgentId} URL {AgentAddress} Агент активен";
            }
            else
            {
                return $"Агент {AgentId} URL {AgentAddress} Агент спит";
            }
        }
